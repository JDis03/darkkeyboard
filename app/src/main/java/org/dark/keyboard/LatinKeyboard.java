...
/**
 * Extension of {@link Keyboard} that adds language-specific features for Latin-based keyboards.
 * <p>
 * Features include:
 * </p>
 * <ul>
 *     <li>Shift lock and caps lock support</li>
 *     <li>Space bar gesture for language switching</li>
 *     <li>Voice input button</li>
 *     <li>Settings button</li>
 *     <li>Preferred letter prediction</li>
 *     <li>Extension keyboard support (Fn row)</li>
 * </ul>
 */
public class LatinKeyboard extends Keyboard {
    ...
    // Icon drawables for various keys
    @Nullable
    ...
    // Keyboard mode and configuration
    private int mMode;
    ...
    /**
     * Cached vertical gap between key rows. 
     * Note: Consider removing when Keyboard.mDefaultVerticalGap becomes accessible.
     */
    ...
    public LatinKeyboard(Context context, int xmlLayoutResId, int mode, float kbHeightPercent) {
        ...
        // Initialize space key tracking for efficient access
    ...
    /**
     * Configures Enter key appearance and behavior based on IME options.
     * Note: Consider refactoring into smaller focused methods for better maintainability.
     */
    ...
    /**
     * Enhanced Key class with Latin keyboard specific functionality.
     * Note: Consider making this a static class for better memory efficiency.
     */
    class LatinKey extends Key {
        ...
        public boolean isInside(int x, int y) {
            // Use custom hit detection logic from parent keyboard
            // Note: Could be simplified if Key.parent field were accessible
